...
with st.container():
    ...
    with image_col:
        leet = r"https://www.google.com/url?sa=i&url=https%3A%2F%2Fleetcode.com%2Fsubscribe%2F&psig=AOvVaw1XrEMyTfrx-i2bDtl0hv7K&ust=1652296699193000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCLjltoHT1fcCFQAAAAAdAAAAABAN"
        st.image(leet)
    with text_col:
...
with st.container():
    ...
    with linkedin_container:
        linke = r"https://www.google.com/url?sa=i&url=https%3A%2F%2Fen.m.wikipedia.org%2Fwiki%2FFile%3ALinkedIn_logo_initials.png&psig=AOvVaw1nOpaaUjbnANWQhE470IQL&ust=1652296728363000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCPj_mI_T1fcCFQAAAAAdAAAAABAD"
        st.image(linke)
        st.markdown("[Link to my profile.](https://www.linkedin.com/in/swakshwar-ghosh-076425211/)")
    
    with github_container:
        github = r"https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.flaticon.com%2Ffree-icon%2Fgithub-logo_25231&psig=AOvVaw1i2aQ3HzotMR1CX7lZm-vn&ust=1652296748245000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCNCyo5rT1fcCFQAAAAAdAAAAABAD"
        st.image(github)
        st.markdown("[Link to my profile.](https://github.com/swaksh-war/)")
    
    with instagram_container:
        st.image("https://www.google.com/url?sa=i&url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FFile%3AInstagram_logo_2016.svg&psig=AOvVaw3WbcMVPOmfV0r5mb1NTn0A&ust=1652296774976000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCOi8-aXT1fcCFQAAAAAdAAAAABAD")
